# ============================================================
# GGM - Correlaciones parciales
# Versión: diff_effort tratado como VARIABLE INDEPENDIENTE (VI)
#
# NOTA METODOLÓGICA: las correlaciones parciales son matemáticamente
# simétricas. Los valores numéricos de r, IC y p son IDÉNTICOS al
# script con diff_effort como VD. Lo único que cambia es el marco
# conceptual (etiquetado y notación), no la estadística.
# ============================================================
...
cat("\n=== CORRELACIONES PARCIALES (aristas GGM) ===\n")
cat("[diff_effort tratado como VI]\n\n")
...
# ============================================================
# Gráfico de red GGM (diff_effort como VI)
# ============================================================
...
# --- Datos de nodos (diff_effort etiquetado como VI) ---
nodes <- data.frame(
  x     = c(200,        480,        340),
  y     = c(200,        200,        360),
  label = c("MAIA_DIRt\nInterocepción",
...
ggplot() +
  ...
  annotate("text", x = 30, y = 378, hjust = 0, size = 2.8,
           color = "grey50",
           label = "Correlaciones parciales (GGM, N = 84, diff_effort = VI)") +
...
ggm_subgrupo <- function(data, etiqueta) {
  cat("\n", strrep("=", 50), "\n", sep = "")
  cat("GRUPO:", etiqueta, "  |  N =", nrow(data), "  [diff_effort como VI]\n")
  cat(strrep("=", 50), "\n\n", sep = "")
...
## Función: gráfico GGM para un subset (diff_effort etiquetado como VI)
